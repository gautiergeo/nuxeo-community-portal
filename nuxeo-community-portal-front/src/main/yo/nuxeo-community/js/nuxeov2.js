var nuxeo = (function(nuxeo) {
  ...
  Client.prototype.user = function(data) {
    return new User({
      client: this,
      data: data,
      timeout: this._timeout,
  ...
  User.prototype.timeout = function(timeout) {
    this._timeout = timeout;
    return this;
  };

  User.prototype.header = function(name, value) {
    this._headers[name] = value;
    return this;
  };

  User.prototype.headers = function(headers) {
    this._headers = jQuery.extend(true, {}, this._headers, headers);
    return this;
  };

  User.prototype.repositoryName = function(repositoryName) {
    this.repository = repositoryName;
    return this;
  };

  User.prototype.schema = function(schema) {
    this._schemas.push(schema);
    return this;
  };

  User.prototype.schemas = function(schemas) {
    this._schemas.push.apply(this._schemas, schemas);
    return this;
  };

  User.prototype.adapter = function(adapter) {
    this._adapter = adapter;
    return this;
  };

  User.prototype.set = function(properties) {
    this.dirtyProperties = jQuery.extend(true, {}, this.dirtyProperties, properties);
    this.properties = jQuery.extend(true, {}, this.properties, properties);
    return this;
  };
  ...
  User.prototype.fetch = function(callback) {
    var self = this;
    var path = join('user', this.username);
    console.log(path);
    var request = this._client.request(path);
    request.timeout(this._timeout).schemas(this._schemas).headers(this._headers)
      .repositoryName(this.repository);
